/*
This time you do not need coding in function. You just need to write 
a regular expression that matches the specified numeric string. I've 
given the regular expression name: "regex", please don't modify 
the name.
...
It can also be a negative number(This means that the string may 
be started by "-", maybe not)
